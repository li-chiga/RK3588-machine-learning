...
case $target_board in
	ATK_DLRK3568)
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3568-atk-evb1-mipi-dsi-1080p.dtb -j$RK_JOBS
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3568-atk-evb1-mipi-dsi-720p.dtb -j$RK_JOBS
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3568-atk-evb1-mipi-dsi-10p1_800x1280.dtb -j$RK_JOBS
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3568-atk-evb1-non-mipi.dtb -j$RK_JOBS
		;;
	ATK_DLRK3588)
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3588-atk-mipi-10p1_800x1280.dtb -j$RK_JOBS
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3588-atk-mipi-5p5_1080x1920.dtb -j$RK_JOBS
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3588-atk-mipi-5p5_720x1280.dtb -j$RK_JOBS
		make $ADDON_ARGS ARCH=$RK_ARCH rockchip/rk3588-atk-non-mipi.dtb -j$RK_JOBS
		;;
	*)
		#直接退出
		exit 0
...
rm -rf resource.img
python2 scripts/mkmultidtb.py "$target_board"
